  ...
  return (
    <div className="consultation-nav">
      ...
      <ul>
        ...
        <Link to="/consultation/case">
          <li
            className={
              path.includes(
                "case/case-data".toLowerCase() && "consultation/case"
              )
                ? "active-nav"
                : null
            }
